...
\begin{figure}
\includegraphics[width=0.8\linewidth]{figs/mikk_behaviour/coverage_F2} \caption{Mean depth of sequencing coverage per chromosome for the 271 F2 samples used in this analysis.}\label{fig:F2-coverage}
\end{figure}
...
\hypertarget{chapter-refmikk-f2-chap-supplementary-information}{%
\chapter{Chapter \ref{MIKK-F2-chap}: supplementary information}\label{chapter-refmikk-f2-chap-supplementary-information}}
...
\hypertarget{supplmentary-information-for-chapter-reffst-chap}{%
\chapter{Supplmentary information for Chapter \ref{Fst-chap}}\label{supplmentary-information-for-chapter-reffst-chap}}
