...
As the \emph{Beagle} travelled down the eastern coast of South America, Darwin collected a vast amount of living specimens and ancient fossils -- including large extinct mammals such as the megatherium (\textbf{Figure \ref{fig:megatherium}}) -- and shipped them back to England (Mukherjee 2016).
...
\caption{Megatherium fossil collected by Charles Darwin, housed in the Natural History Museum, London. Photograph from {``What Was {Megatherium}?''} (n.d.).}\label{fig:megatherium}
\end{wrapfigure}
...
\caption{Portrait of Karl Pearson in 1910 (Commons 2020b).}\label{fig:pearson}
\end{wrapfigure}
...
\caption{Undated photo of Frederick Sanger from Commons (2020a).}\label{fig:sanger}
\end{wrapfigure}
...
\leavevmode\vadjust pre{\hypertarget{ref-sanger}{}}%
---------. 2020a. {``File:frederick Sanger2.jpg --- Wikimedia Commons{,} the Free Media Repository.''} \url{/url\%7Bhttps://commons.wikimedia.org/w/index.php?title=File:Frederick_Sanger2.jpg\&oldid=395411415\%7D}.

\leavevmode\vadjust pre{\hypertarget{ref-pearsonPhoto}{}}%
---------. 2020b. {``File:karl Pearson, 1910.jpg --- Wikimedia Commons{,} the Free Media Repository.''} \url{/url\%7Bhttps://commons.wikimedia.org/w/index.php?title=File:Karl_Pearson,_1910.jpg\&oldid=477532248\%7D}.
...
\leavevmode\vadjust pre{\hypertarget{ref-WhatWasMegatherium}{}}%
