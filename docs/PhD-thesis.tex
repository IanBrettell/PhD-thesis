...
\hypertarget{japanese-courage-a-genetic-analysis-of-complex-traits-in-medaka-fish-and-humans}{%
\section*{Japanese courage: a genetic analysis of complex traits in medaka fish and humans}\label{japanese-courage-a-genetic-analysis-of-complex-traits-in-medaka-fish-and-humans}}

\hypertarget{ian-brettell}{%
\subsection*{Ian Brettell}\label{ian-brettell}}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figs/mikk_genome/circos/55-2} \caption{Proportion of homozygous SNPs within 5 kb bins in the MIKK panel line 55-2 (\emph{blue}), and number of SNPs in each bin (\emph{yellow}).}\label{fig:circos-55-2}
\end{figure}



\begin{figure}
\includegraphics[width=1\linewidth]{figs/mikk_genome/circos/iCab_F24} \caption{Proportion of homozygous SNPs within 5 kb bins in the previously established \emph{iCab} strain at generation F\textsubscript{24} (dark grey), and number of SNPs in each bin (yellow).}\label{fig:circos-iCab-F24}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figs/pilot/0.08_14_cooc_heatmap_annotated} \caption{Frequency of HMM state co-occupancy between pairs of fish, calculated across all videos per strain-pairing.}\label{fig:pilot-cooc-heat}
\end{figure}
...
\caption{\label{tab:psm-final-genes}Target genes containing predicted missense variants for functional validation expressed in the unsegmented PSM and containing protein alterations. Table generated by Ali Seleit.}
\centering
\resizebox{\linewidth}{!}{
...
To illustrate the differences between certain lines in terms of both direct and indirect genetic effects, in \textbf{Figure \ref{fig:extreme-paths}} I have plotted the tracked paths for 3 lines 5 minutes into the 10-minute open field assay component: the slowest line \definecolor{22-1 (‘David’)_FB737A}{HTML}{FB737A}\textcolor{22-1 (‘David’)_FB737A}{22-1 (‘David’)},\footnote{In our group, we gave several lines nicknames to facilitate discussions about them. In almost all cases, for the entirety of the assay, David remained as still (and captivating) as Michelangelo's statue.} one of the other slowest lines \definecolor{18-2 (‘Elsa’)_FF66A6}{HTML}{FF66A6}\textcolor{18-2 (‘Elsa’)_FF66A6}{18-2 (‘Elsa’)},\footnote{Elsa was Frozen like David, but far more charismatic.} and the fastest line \definecolor{10-1 (‘Janeway’)_F8766D}{HTML}{F8766D}\textcolor{10-1 (‘Janeway’)_F8766D}{10-1 (‘Janeway’)}. The fishes are coloured by their line, with \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} in dark grey. There appears to be a indirect genetic effect when comparing the behaviour of \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} when paired with the similarly slow-moving lines and \definecolor{18-2 (‘Elsa’)_FF66A6}{HTML}{FF66A6}\textcolor{18-2 (‘Elsa’)_FF66A6}{18-2 (‘Elsa’)}. At the other extreme, line \definecolor{10-1 (‘Janeway’)_F8766D}{HTML}{F8766D}\textcolor{10-1 (‘Janeway’)_F8766D}{10-1 (‘Janeway’)} moved extremely quickly,\footnote{Janeway moved so fast it appeared she was approaching warp speed.} spending much of its time moving along the boundaries of their test tanks. I understand from our collaborator Felix Loosli, a fish behaviour expert, that this movement along the boundaries of a tank (known as ``thigmotaxis'') is typical of medaka when introduced to a novel environment, and I observe it too with \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} when it is paired with line \definecolor{22-1 (‘David’)_FB737A}{HTML}{FB737A}\textcolor{22-1 (‘David’)_FB737A}{22-1 (‘David’)}.



\begin{figure}
\includegraphics[width=1\linewidth]{figs/mikk_behaviour/path_plot_22-1_18-2_10-1_300} \caption{Path plots for lines \definecolor{22-1 (‘David’)_FB737A}{HTML}{FB737A}\textcolor{22-1 (‘David’)_FB737A}{22-1 (‘David’)} (\textbf{A}), \definecolor{18-2 (‘Elsa’)_FF66A6}{HTML}{FF66A6}\textcolor{18-2 (‘Elsa’)_FF66A6}{18-2 (‘Elsa’)} (\textbf{B}) and \definecolor{10-1 (‘Janeway’)_F8766D}{HTML}{F8766D}\textcolor{10-1 (‘Janeway’)_F8766D}{10-1 (‘Janeway’)} (\textbf{C}) 5 minutes into the open field assay for the first (left) and second (right) run with each line. The paths of \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} individuals are coloured in dark grey, with the other lines depicted in their representative colours.}\label{fig:extreme-paths}
\end{figure}
...
As discussed above, in this project our traits of interest include not only direct genetic behaviours, but also indirect genetic behaviours. I therefore sought to identify the MIKK panel lines that transmit their behaviour onto the reference \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} tank partners either to the greatest or least extent. I refer to this transmission of behaviour as ``\textbf{\emph{charisma}}'', to capture the element of behavioural influence. I formulated two methods to measure charisma, which I refer to as a) HMM state co-occupancy; and b) reference deviation. The first, HMM state co-occupancy, measures the proportions of time that the \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} reference fish spends in the same HMM state as its tank partner. The second, deviation of the reference fishes' behaviour from the behaviour exhibited in the \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}}-\emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} condition, seeks to quantify the extent to which the \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}}'s behaviour changes when partnered with each MIKK panel line.
...
\textbf{Figures \ref{fig:F2-time-sge-of}} and \textbf{\ref{fig:F2-time-sge-no}} highlight the states that showed significant differences in the proportions of time that \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} spent in those states when paired with the 6 parental lines for the open field and novel object assay components respectively. In both figures, \textbf{A} highlights the significant states, \textbf{B} shows how the \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} individuals moved through those states over the course of the 10-minute assay component, and \textbf{C} shows the densities of the significant states within each line.
...
\begin{figure}
\includegraphics[width=1\linewidth]{figs/mikk_behaviour/0.08_15_state_freq_F2_sge} \caption{Effect of inverse-normalisation on the HMM state frequency of the \emph{\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}} reference fishes paired with the MIKK F\textsubscript{2} fishes.}\label{fig:F2-state-freq-sge}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figs/mikk_behaviour/F2LD_ld_window-10_miss-thresh-1_min-maf-0.3} \caption{A: Number of samples in each cross. B: Mean LD decay calculated in 100-bp windows for each cross.}\label{fig:F2-LD-decay}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{figs/mikk_behaviour/grm_man_0.8} \caption{Genetic relationship matrix (GRM) for 271 F\textsubscript{2} samples based on 44,360 non-missing SNPs.}\label{fig:F2-grm}
\end{figure}
...
As expected, most variants reside in non-coding regions (Zhang and Lupski 2015), but in an attempt to isolate the most likely causative SNPs, I extracted those that are predicted to cause a missense mutation and therefore most likely to have a functional consequence (\textbf{Table \ref{tab:F2-sig-snps-missense}}).
...
\begin{figure}
\includegraphics[width=1\linewidth]{figs/fst/circos_fst_all} \caption{Circos plot showing \(F_{ST}\) values for a random selection of 10,000 SNPs across the human genome.}\label{fig:fst-circos}
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-baudIndirectGeneticEffects2022}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-bellDevelopmentBehaviouralDifferences2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-bleakleyIndirectGeneticEffects2009}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-broekemaPracticalViewFinemapping2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-budaevPersonalityGuppyPoecilia1997}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-cano-gamezGWASFunctionUsing2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-churchillCollaborativeCrossCommunity2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-collaborativecrossconsortiumGenomeArchitectureCollaborative2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-coventryEstimatingExtentParameter2005}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-farhGeneticEpigeneticFine2015}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-griffingSelectionReferenceBiological1967}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-jaffeGenotypebygenotypeEpistasisExploratory2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kellerQuantifyingAddressingParameter2005}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kumasakaFinemappingCellularQTLs2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-legerGenomicVariationsEpigenomic2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lipkinUseKosherPhenotyping2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-mackayDrosophilaMelanogasterGenetic2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-monkeOptimalTimeFrequency2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-schaidGenomewideAssociationsCandidate2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-shorterMaleInfertilityResponsible2017}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-stevensInferenceRelationshipsPopulation2011}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-sundstromHatcherySelectionPromotes2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-threadgillTenYearsCollaborative2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-threadgillGeneticDissectionComplex2002}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ulebergFineMappingMultiple2007}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-visscherConfidenceIntervalsQTL1996}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-wrightQTLAnalysisBehavioral2006}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-yoshidaComparisonBehavioralResponses2005}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-zhangNoncodingGeneticVariants2015}{}}%
...
\hypertarget{novel-object-1}{%
\subsection{Novel object}\label{novel-object-1}}
