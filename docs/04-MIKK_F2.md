...
(ref:extreme-paths) Path plots for lines 22-1 (**A**), 18-2 (**B**) and 10-2 (**C**) 5 minutes into the open field assay for the first (left) and second (right) run with each line. The paths of *\definecolor{iCab_424B4D}{HTML}{424B4D}\textcolor{iCab_424B4D}{iCab}* individuals are coloured in dark grey, with the other lines depicted in their representative colours.
