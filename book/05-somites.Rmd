...
```{r somite-period-ali, echo = F, fig.cap = '(ref:somite-period-ali)', out.width='50%'}
knitr::include_graphics(here::here("book/figs/somites/somite_period_ali.png"), auto_pdf = T)
```
