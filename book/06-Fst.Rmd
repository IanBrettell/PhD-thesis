...
1. The sample populations may differ in linkage disequilibrium (**LD**) structure, which would change the causal variant effect sizes even when the variants themselves are the same [@martinClinicalUseCurrent2019].

1. allele frequencies of the causal variants, and the distribution of the effect sizes of the causal variants [@martinHumanDemographicHistory2017; @scutariUsingGeneticDistance2016]. 

1. The environments and demographies between differ between populations [@martinClinicalUseCurrent2019]. 
...
Many SNP arrays or sequencing procedures In addition, if imputation panels are used to impute missing genotypes, they are likely to miss the rare variants that are unrepresentated int he imputations panels.
