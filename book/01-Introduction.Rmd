...
```{r lamarck, echo = F, fig.cap = '(ref:lamarck)', out.width='100%', fig.align='left', wrapfigure = list("L", .4)}
...
```{r mendel, echo = F, fig.cap = '(ref:mendel)', out.width='100%', fig.align='right', wrapfigure = list("R", .5)}
...
```{r F0-Cab-Kaga-HdrR, echo = F, fig.cap = '(ref:F0-Cab-Kaga-HdrR)', out.width='100%', fig.align='right', wrapfigure = list("R", .5)}
...
```{r somite-period-ali, echo = F, fig.cap = '(ref:somite-period-ali)', out.width='100%', fig.align='left', wrapfigure = list("L", .5)}
