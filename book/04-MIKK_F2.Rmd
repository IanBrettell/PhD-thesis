...
```{r F0-line-mean-speed-var_select, echo = F, fig.cap = '(ref:F0-line-mean-speed-var_select)', out.width='100%'}
...
knitr::include_graphics(here::here("book/figs/mikk_behaviour/select_0.05_15_dge_of.png"), auto_pdf = T)
```
