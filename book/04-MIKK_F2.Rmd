...
```{r sig-snp-10-15mb, echo = F, fig.cap = '(ref:sig-snp-10-15mb)', out.width='50%'}
...
```{r F2-coverage, echo = F, fig.cap = '(ref:F2-coverage)', out.width='80%'}
...
* Mention more interesting phenotypes like shoaling behaviours
