...
TARGET_SNPS = c("5:24433800", "6:30807013", "9:9802754", "10:18537719")
...
These results confirm that the F2 cross method applied to the MIKK panel is a powerful technique for the discovery of loci associated with complex traits. I applied modern computational methods to develop a data-driven analysis of fish behaviour and select inbred lines that diverged in both their own behaviour and the extent to which they transmitted them to their social partners, and performed an F2 cross with those lines to map the genetic variants associated with those differences. Although this analysis was under-powered, I nevertheless discovered statistically significant loci in orthologue genes that have been found to be related to neurological phenotypes in mice, rats, and humans. 
